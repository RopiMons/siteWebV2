...
var inArea,
    ...
    captions = {
        ...
        banque: ["Banques externes", "Je souhaite soutenir une économie locale et engagée sur le chemin de la transition (https://fr.wikipedia.org/wiki/Ville_en_transition). Je commande mes Ropi par internet ou en me rendant chez un commerçant. J'achète des produits et services en Ropi chez des commerçants ou producteurs locaux car le Ropi n'est pas accepté à l'extérieur de la région ni par les grandes enseignes. Ce simple geste permet d'**engager la boucle** de l'économie circulaire. Un Ropi ne peut pas être déposé dans une banque autre que la banque Ropi. Les Euro convertis en Ropi ne peuvent donc plus financer des activités hors de l'économie locale (bien souvent des investissements irresponsables)"]
    },
    single_opts = {
        fillColor: '000000',
        fillOpacity: 0,
