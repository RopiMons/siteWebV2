...
class LoadPageDynamiqueData extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        $tab = array(
            ...
            array(5, "Devenir membre de l'ASBL", 1, new DateTime("2015-05-27T20:39:18+02:00"), new DateTime("2015-05-27T20:39:18+02:00"), new DateTime("2015-01-01T00:00:00+01:00"), $this->getReference("CAT_5"), "", array($this->getReference("PERM_ROLE_ADMIN"),$this->getReference("PERM_ROLE_CMS_CREATE"),$this->getReference("PERM_ROLE_COMMERCANT"),$this->getReference("PERM_ROLE_UTILISATEUR_ACTIVE"))),
            array(6, "Gérer mes données", 1, new DateTime("2015-05-27T20:39:18+02:00"), new DateTime("2015-05-27T20:39:18+02:00"), new DateTime("2015-01-01T00:00:00+01:00"), $this->getReference("CAT_5"), "ropi_account", array($this->getReference("PERM_ROLE_ADMIN"),$this->getReference("PERM_ROLE_CMS_CREATE"),$this->getReference("PERM_ROLE_COMMERCANT"),$this->getReference("PERM_ROLE_UTILISATEUR_ACTIVE"))),
            array(7, "Me déconnecter", 1, new DateTime("2015-05-27T20:39:18+02:00"), new DateTime("2015-05-27T20:39:18+02:00"), new DateTime("2015-01-01T00:00:00+01:00"), $this->getReference("CAT_5"), "logout", array($this->getReference("PERM_ROLE_ADMIN"),$this->getReference("PERM_ROLE_CMS_CREATE"),$this->getReference("PERM_ROLE_COMMERCANT"),$this->getReference("PERM_ROLE_UTILISATEUR_ACTIVE"))),
            ...
            array(4, "Zone Admin membres", 1, new DateTime("2015-05-27T20:39:18+02:00"), new DateTime("2015-05-27T20:39:18+02:00"), new DateTime("2015-01-01T00:00:00+01:00"), $this->getReference("CAT_6"), "Ropi_admin_user_listing", array($this->getReference("PERM_ROLE_ADMIN")))
            );
